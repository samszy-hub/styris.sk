        ...
        <div className="k-grid">
          ...
          <div className="kform-embed-wrap reveal" data-d="1">
            <div className="kform-embed">
              ...
              <iframe data-tally-src={`https://tally.so/embed/${TALLY_FORM_ID}?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1`} loading="lazy" width="100%" height="520" frameBorder="0" title="Dopytový formulár STYRIS"></iframe>}
            </div>
